...
Added improvements:
✅ Uses dataset fields: beaker_ml, condition, view, volume_ml
✅ Structured prompts to reduce MAE and improve R²
✅ Numeric-only answers during training
✅ Stronger LoRA target modules + higher rank
"""
...
# =============================================================================
# ✅ STRUCTURED PROMPT + NUMERIC ANSWER (NEW)
# =============================================================================
...
def build_structured_prompt(ex):
    ...
    return (
        f"<VQA>This is a {view} view of a {beaker_ml}mL laboratory beaker in a {condition} background. "
        f"Return ONLY the liquid volume in milliliters. "
        f"Output must be a number between 0 and {beaker_ml}. "
...
# =============================================================================
# FLORENCE TRAINER (UPDATED PROMPT + ANSWER)
# =============================================================================
...
# =============================================================================
# QWEN TRAINER (UPDATED PROMPT + ANSWER)
# =============================================================================
...
# =============================================================================
# EVALUATOR (UPDATED TO USE STRUCTURED PROMPT)
# =============================================================================
